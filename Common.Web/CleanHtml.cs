...
{
    /// <summary>
    /// This class is used to help remove sections from the HTML file to make it smaller for searching and allow for using css 
    /// classes as search critria and prevent false positives.
    /// </summary>
